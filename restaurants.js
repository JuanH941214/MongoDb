...
db.restaurants.find({ "restaurant_id": 1, "name": 1, "borough": 1, "cuisine":1, "camp_id":0 })
...
db.restaurants.find({ "restaurant_id": 1, "name": 1, "borough": 1, "zip code": 1, "camp_id":0 });
...
db.restaurants.find({"address.coord.0": { $lt: -65.754168 }, "grades":{$elemMatch: {"score": { $gt: 70 }}},"cuisine":{$ne:"American "}});
...
db.restaurants.find({"address.coord.0": { $lt: -65.754168 }, "grades":{$elemMatch: {"grade": { $gt: "A" }}},"cuisine":{$ne:"American "}, "borough":{$ne:"Brooklyn"}}).sort({cuisine:-1});
...
db.restaurants.find( { name: /^Wil/ },{ "restaurant_id": 1, "borough": 1, "cuisine":1, "name":1 })
...
db.restaurants.find( { name: /.*Reg.*/i},{ "restaurant_id": 1, "borough": 1, "cuisine":1, "name":1 })
...
db.restaurants.find({ grades:{$elemMatch: {"score": { $lt: 10 }}}}, { "restaurant_id": 1, "name": 1, "borough": 1, "cuisine":1, "grades.score":1 });
...
db.restaurants.find({"cuisine":{$nin:["Chinese", "American "]},"name":{$not: /^Wil/ }}, {"restaurant_id": 1, "name": 1, "borough": 1, "cuisine":1});
...
db.restaurants.find({"grades.grade":"A", "grades.score":11, "grades.date": ISODate("2014-08-11T00:00:00Z")},{"restaurant_id": 1, "name": 1, "borough": 1, "cuisine":1, "grades":1});
...
db.restaurants.find({"grades.1.grade":"A", "grades.1.score":9, "grades.date": ISODate("2014-08-11T00:00:00Z")},{"restaurant_id": 1, "name": 1, "borough": 1, "cuisine":1, "grades":1});
...
db.restaurants.find({"address.coord.1":{$gt: 42, $lt: 52}},{"restaurant_id": 1, "name": 1, "borough": 1, "adress":1,"coord":1});
